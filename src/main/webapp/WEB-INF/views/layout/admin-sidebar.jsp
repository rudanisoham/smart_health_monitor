<aside class="admin-sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<%= request.getContextPath() %>/admin/lab-staff"
           class="sidebar-link <%= "lab-staff".equals(request.getAttribute("activePage")) ? "active" : "" %>">
            <span class="icon">
                <svg class="nav-icon" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path>
                </svg>
            </span>
            <span class="sidebar-text">Lab Staff</span>
        </a>
        ...
        <a href="<%= request.getContextPath() %>/admin/site-content"
           class="sidebar-link <%= "site-content".equals(request.getAttribute("activePage")) ? "active" : "" %>">
            <span class="icon">
                <svg class="nav-icon" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2">
