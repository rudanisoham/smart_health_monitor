...
<%
    ...
    request.setAttribute("pageSubtitle", "Update your medical staff profile");
%>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <main class="admin-main">
        ...
        <div class="admin-content">
            ...
            <div class="card" style="max-width:600px;">
                ...
                <form action="${pageContext.request.contextPath}/medical/profile/update" method="post" class="form-grid mt-3">
                    <div class="form-group"><label>Full Name</label><input type="text" name="fullName" class="form-control" value="${user.fullName}" required></div>
                    <div class="form-group"><label>Email</label><input type="email" class="form-control" value="${user.email}" disabled style="opacity:0.6;"></div>
