    ...
    <main class="admin-main">
        ...
        <div class="admin-content">
            ...
            <div class="no-print" style="display:flex;gap:0.75rem;margin-bottom:1.5rem;flex-wrap:wrap;">
                <a href="${pageContext.request.contextPath}/doctor/prescriptions" class="btn btn-outline btn-sm">← Back to Prescriptions</a>
                ...
                <div style="display:flex;justify-content:space-between;align-items:flex-start;flex-wrap:wrap;gap:1rem;">
                    ...
                    <div style="text-align:right;">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <span style="background:rgba(255,255,255,0.2);padding:0.4rem 1rem;border-radius:999px;font-size:0.85rem;font-weight:700;">
            ...
            <div class="grid grid-2" style="margin-bottom:1.5rem;">
                ...
                <div class="card">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value">#${prescription.patient.id}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Blood Group</span>
                        <span class="info-value">${prescription.patient.bloodGroup != null ? prescription.patient.bloodGroup : '—'}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Phone</span>
                        <span class="info-value">${prescription.patient.user.phone != null ? prescription.patient.user.phone : '—'}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Allergies</span>
                        <span class="info-value">${prescription.patient.allergies != null ? prescription.patient.allergies : 'None recorded'}</span>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value">${prescription.doctor.licenseNumber}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Diagnosis</span>
                        <span class="info-value" style="font-weight:700;color:#1d4ed8;">${prescription.diagnosis}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Issued On</span>
                        <span class="info-value">${prescription.createdAt.toString().replace('T',' ').substring(0,16)}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="card" style="margin-bottom:1.5rem;">
                ...
                <c:choose>
                        ...
                        <div class="table-container">
                            <table class="med-table">
                                ...
                                <c:forEach var="med" items="${prescription.prescribedMedicinesList}" varStatus="vs">
                                    <tr>
                                        <td style="color:var(--text-muted);font-weight:700;">${vs.index + 1}</td>
                                        <td>
                                            <strong>${med.medicineName}</strong>
                                        </td>
                                        <td>
                                            <span style="background:#eff6ff;color:#1d4ed8;padding:0.2rem 0.6rem;border-radius:4px;font-size:0.82rem;font-weight:700;">
                                                ${med.dosage}
                                            </span>
                                        </td>
                                        <td>${med.timing}</td>
                    ...
                    <c:otherwise>
                        <!-- Fallback: show plain medicines text if no structured list -->
                        <c:choose>
                            <c:when test="${not empty prescription.medicines and prescription.medicines != 'See structured list'}">
                                <div style="padding:1rem;background:#f8fafc;border-radius:8px;white-space:pre-wrap;font-size:0.9rem;color:#0f172a;">
            ...
            <div class="grid grid-2">
                <div class="card">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <div class="muted">No special instructions.</div>
                        </c:otherwise>
                    </c:choose>
                </div>
