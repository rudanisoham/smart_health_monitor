...
<head>
    <meta charset="UTF-8">
    <title>Doctor Login · Smart Health Monitor</title>
    ...
    <div class="login-card">
        <div class="login-main">
            <div class="login-badge">
                <span>Smart Health Monitor · Doctor</span>
            </div>
            <h1 class="login-title">Doctor sign in</h1>
            ...
            <form action="${pageContext.request.contextPath}/auth/login" method="post" class="form-grid">
                <input type="hidden" name="roleStr" value="DOCTOR">
                <div class="form-group">
                    <label for="email">Email</label>
                    <input id="email" name="email" type="email" class="form-control" placeholder="doctor@hospital.com" required>
                </div>
                <div class="form-group">
            ...
            <div class="login-footer">
                ...
                <a href="<%= request.getContextPath() %>/auth/doctor/register" class="text-xs" style="color:#38bdf8; text-decoration: none; font-weight: 500;">Submit an application</a>
            </div>
        </div>
        ...
        <div class="login-extra" style="display: flex; flex-direction: column; justify-content: center; height: 100%;">
            <div class="login-kpi" style="background: transparent; border: none; padding: 0;">
                <h3 style="font-size: 1.5rem; margin-bottom: 1rem; color: #fff;">Empowering Clinical Excellence</h3>
                <ul style="list-style: none; padding: 0; margin: 0; color: #94a3b8; font-size: 0.95rem; line-height: 1.6;">
                    <li style="margin-bottom: 0.75rem; display: flex; align-items: flex-start; gap: 0.75rem;">
                        <span style="color: #38bdf8;">✓</span> AI-powered patient risk analytics and alerts
                    </li>
                    <li style="margin-bottom: 0.75rem; display: flex; align-items: flex-start; gap: 0.75rem;">
                        <span style="color: #38bdf8;">✓</span> Instant access to vital diagnostic telemetry
                    </li>
                    <li style="margin-bottom: 0.75rem; display: flex; align-items: flex-start; gap: 0.75rem;">
                        <span style="color: #38bdf8;">✓</span> Streamlined digital prescription workflows
                    </li>
                    <li style="display: flex; align-items: flex-start; gap: 0.75rem;">
                        <span style="color: #38bdf8;">✓</span> Integrated appointment and schedule management
                    </li>
                </ul>
            </div>
            <div class="mt-8">
